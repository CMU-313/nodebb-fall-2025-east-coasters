...
module.exports = function (Topics) {
  Topics.getTeasers = async function (topics, options) {
    ...
    const [allPostData, callerSettings] = await Promise.all([posts.getPostsFields(teaserPids, ['pid', 'uid', 'timestamp', 'tid', 'content', 'sourceContent', 'anonymous']), user.getSettings(uid)]);
